...
(1, 2147483647, 'Customer A', '123 Customer Street, Customer City', '123-456-7890', 'customerA@example.com'),
(2, 2147483647, 'Customer B', '456 Customer Road, Customer Town', '987-654-3210', 'customerB@example.com'),
(3, 2147483647, 'Customer C', '789 Customer Avenue, Customer Village', '567-890-1234', 'customerC@example.com'),
(4, 2147483647, 'Customer D', '987 Customer Lane, Customer Hamlet', '432-109-8765', 'customerD@example.com'),
(5, 2147483647, 'Customer E', '654 Customer Drive, Customer Borough', '901-234-5678', 'customerE@example.com');
...
(1, 221001009, 'Aya', 'Mariyani', 'aya77', 'Admin', 'riamarnnia@gmail.com', 'Jl. Handil Bakti', 'Active'),
